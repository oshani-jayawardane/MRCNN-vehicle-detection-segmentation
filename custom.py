...
dataset_path = "D:/FYP/breast-cancer/Mask-RCNN-car-truck/dataset"
annotations_path_train = os.path.join("D:/FYP/breast-cancer/Mask-RCNN-car-truck/dataset/train/train_json.json") 
annotations_path_val = os.path.join("D:/FYP/breast-cancer/Mask-RCNN-car-truck/dataset/val/val_json.json") 

# Root directory of the project
ROOT_DIR = "D:/FYP/breast-cancer/Mask-RCNN-car-truck"
...
class CustomConfig(Config):
    ...
    NUM_CLASSES = 1 + 2  # Background + (car,truck)
...
class CustomDataset(utils.Dataset):
    ...
    def load_custom(self, dataset_dir, subset, annotations_path):
        ...
        for a in annotations:
            ...
            # For huge datasets, you would need to add a meta data file or
            # save the image width and height in the JSON.
            # ****************************************************************
    ...
    def load_mask(self, image_id):
       ...
       Returns:
        ...
        """
        # If not a car-truck dataset image, delegate to parent class.
...
def train(model):
    ...
    dataset_train.load_custom(dataset_path, "train", annotations_path_train)
    dataset_train.prepare()
    print('Train %d' % len(dataset_train.image_ids))

    # Validation dataset
    dataset_val = CustomDataset()
    dataset_val.load_custom(dataset_path, "val", annotations_path_val)
    dataset_val.prepare()
    ...
    model.train(dataset_train, dataset_val,
                ...
                augmentation=imgaug.augmenters.Sequential([
                    ...
                    imgaug.augmenters.AddToHueAndSaturation(
